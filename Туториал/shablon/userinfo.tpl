<div class="block">
<div class="block-head">Профиль {group}a {usertitle} <div style="float: right;">{edituser}</div></div>
...
<tr><td class="user_mInfo_title">Количество комментариев</td><td class="user_mInfo_text">{comm-num}</td></tr>
