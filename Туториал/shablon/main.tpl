...
[group=5]
<div class="togame">
    <a href="/register/first-step/"><div class="togame_reg"><span class="icon-plus3" style="padding-right: 15px;"></span>Зарегистрироваться</div></a>
</div>
[/group]
[not-group=5]
<div class="togame">
    <a href="/download/launcher"><div class="togame_but"><span class="icon-download" style="padding-right: 15px;"></span>Загрузить лаунчер</div></a>
</div>
[/not-group]
</div>
...
<div class="news_pad">
    <ul class="nav">
		...
		[/group]
		[not-group=5]
        <li><a href="/forum/"><span class="icon-chat"></span> Форум</a></li>
		[/not-group]
