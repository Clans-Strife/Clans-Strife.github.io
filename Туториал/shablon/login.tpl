[not-group=5]
		...
		<div class="profcontent">
			...
			<li><span class="icon-tools"></span><a href="/cabinet/">Личный кабинет</a></li>
			...
			<li><span class="icon-logout"></span><a href="/logout/">Выход</a></li>
			</ul>
		</div>
		<div class="balance">
...
[group=5]
		...
		<input class="cursor auth_reg" value="ЗАРЕГИСТРИРОВАТЬСЯ" onClick="location.href='/register/first-step/'" type="button"/>
